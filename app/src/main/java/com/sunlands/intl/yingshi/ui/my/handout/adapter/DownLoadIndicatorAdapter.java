...
/**
 * 文件名: DownLoadIndicatorAdapter
 * 描    述:
 * 创建人: yanxin
 */
public class DownLoadIndicatorAdapter extends CommonNavigatorAdapter {
    private final List<String> mDataList;
    Context mContext;
    ViewPager mViewPager;

    public DownLoadIndicatorAdapter(Context context, ViewPager viewPager, int arrayResId) {
        mContext = context;
