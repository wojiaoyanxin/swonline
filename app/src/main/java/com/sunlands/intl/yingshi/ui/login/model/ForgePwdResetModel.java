...
public class ForgePwdResetModel extends MvpBaseModel<RestApi> implements ILoginContract.IForgePwdResetModel,ILoginContract.IPhoneLoginModel {
    ...
    @Override
    public void resetPwd(String tel, String code, String newPwd, PublishSubject<Lifecycle.Event> mPublishSubject, MVPModelCallbacks<EmptyBean> mvpModelCallbacks) {
        deploy(getApi().resetPwd(tel,code,newPwd),mPublishSubject,mvpModelCallbacks);
    }
