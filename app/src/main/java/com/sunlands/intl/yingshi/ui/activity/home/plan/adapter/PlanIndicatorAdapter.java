 ...
 * 创建时间: 2018/8/6
 */
public class PlanIndicatorAdapter extends CommonNavigatorAdapter {
    private final List<String> mDataList;
    Context mContext;
    ViewPager mViewPager;

    public PlanIndicatorAdapter(Context context, ViewPager viewPager, int arrayResId) {
        mContext = context;
    ...
    public IPagerTitleView getTitleView(Context context, final int index) {
        ...
        simplePagerTitleView.setPadding(UIUtil.dip2px(mContext, 12), 0,
                UIUtil.dip2px(mContext, 12), 0);
