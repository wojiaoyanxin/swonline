...
/**
 * 作者：闫鑫 on 2018/1/31 15:02
 * 邮箱：yanxin0215@163.com
 * 公司:北京泰合
 */
...
//     */
    ...
    public MyFlowLayout(Context context, AttributeSet attrs) {
        ...
        horizontal_space = array.getDimension(R.styleable.FlowLayout_width_space, DensityUtil.dip2px(context,10));
        vertical_space =  array.getDimension(R.styleable.FlowLayout_height_space,DensityUtil.dip2px(context,10));
        array.recycle();
