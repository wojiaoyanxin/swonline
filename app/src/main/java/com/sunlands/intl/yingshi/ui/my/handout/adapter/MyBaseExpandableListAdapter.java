...
import com.sunlands.intl.yingshi.ui.my.handout.view.DownLoadListActivity;
...
public class MyBaseExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public MyBaseExpandableListAdapter(Context context, List<Map<String, Object>> parentMapList, List<List<Map<String, Object>>> childMapList_list, ExpandableListView expandableListView) {
    ...
    public View getGroupView(final int groupPosition, final boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_handout_parent, null);
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_handout_child, null);
...
//            }
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    DownLoadListActivity.show(context, handoutItem.getCourseId(), handoutItem.getFileName());
                }
            });
        }
        return convertView;
